...
0. **Visual validation beats long-spec validation for Jonathan.** When Jonathan is validating product/UX direction, do not make him review long documents or dense specs as the primary decision surface. Convert the spec into 3-5 low-fidelity visual wireframes, annotated with 3-5 short notes each, before asking for approval. He should be able to react with “I understand / I don’t understand / this feels like a CRM / this feels like a cockpit” without reading hundreds of lines. High-fidelity mockups and visual styling come only after the structure is visually validated.
