...
export const POLICY: Record<string, PolicyEntry> = {
  ...
  // Cockpit Media Buyer : séries, décisions sur les créas, fils et leviers.
  ads_sync_daily:          { module: "media_buyer", verb: "write" },
  ads_decisions_analyze:   { module: "media_buyer", verb: "action" },
  ads_decisions_open:      { module: "media_buyer", verb: "read" },
  ads_decisions_history:   { module: "media_buyer", verb: "read" },
  ads_decisions_propose:   { module: "media_buyer", verb: "write" },
  cockpit_cards_overview:  { module: "media_buyer", verb: "read" },
  cockpit_card_post:       { module: "media_buyer", verb: "write" },
  cockpit_card_history:    { module: "media_buyer", verb: "read" },
  cockpit_set_lever:       { module: "media_buyer", verb: "write" },
  cockpit_synthese_get:    { module: "media_buyer", verb: "read" },
  cockpit_synthese_save:   { module: "media_buyer", verb: "write" },
  cockpit_synthese_history:{ module: "media_buyer", verb: "read" },
  // Onboarding
