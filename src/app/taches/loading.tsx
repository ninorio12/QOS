  ...
  return (
    <div className="h-full flex flex-col overflow-hidden animate-pulse">
      ...
      <div className="px-6 pt-6 pb-4 flex items-center justify-between flex-shrink-0">
        <div className="h-7 w-20 bg-soren-border rounded-xl" />
        ...
        {COLS.map((col, colIdx) => (
          <div key={colIdx} className="flex-1 min-w-[180px] flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2 px-1 mb-1">
              <div className="w-5 h-5 rounded-lg bg-soren-border flex-shrink-0" />
              <div className="h-2.5 bg-soren-border rounded" style={{ width: col.w }} />
              <div className="h-4 w-5 bg-soren-border rounded-full ml-auto" />
            </div>
            ...
            <div className="flex flex-col gap-2">
              {Array.from({ length: col.cards }).map((_, cardIdx) => (
                <div key={cardIdx} className="bg-soren-card rounded-xl border border-soren-border shadow-sm px-3 py-2.5">
                  <div className="h-2.5 bg-soren-border rounded mb-2" style={{ width: `${60 + (cardIdx * 19) % 50}%` }} />
                  <div className="flex items-center gap-2">
                    <div className="h-4 w-12 bg-soren-border rounded-full" />
                    <div className="h-2 w-16 bg-soren-border rounded ml-auto" />
                  </div>
                </div>
              ))}
            </div>
