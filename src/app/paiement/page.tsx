  ...
  return (
    <div className="h-full flex flex-col px-6 py-6">
      <div className="flex-shrink-0 mb-6">
        ...
        <p className="text-sm text-soren-muted mt-1">Suivi des paiements encaissés</p>
      </div>
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-[320px]">
          ...
          <p className="text-sm font-semibold text-soren-text mb-1.5">Connexion bancaire à venir</p>
