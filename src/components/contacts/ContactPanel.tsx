...
const MOCK_LEADS = [
  { id: '1', title: 'Résidence Les Chênes', value: 87000,  status: 'RDV Booké',       color: '#C8F135', date: '20 mars' },
...
export default function ContactPanel({
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 text-[#3D4F6B] hover:text-white transition-colors lg:hidden"
      >
        <X size={18} />
      </button>
      ...
      <div className="p-6 flex flex-col items-center text-center gap-3">
        ...
        <div>
          ...
          {contact.job_title && (
            <p className="text-xs text-[#8896AB] mt-0.5">{contact.job_title}</p>
          )}
          {contact.company && (
      ...
      <div className="p-5 flex flex-col gap-4">
        <h3 className="text-[10px] font-bold text-[#3D4F6B] uppercase tracking-widest">Informations</h3>
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            <div key={label} className="flex flex-col gap-0.5">
              <p className="text-[10px] font-medium text-[#3D4F6B]">{label}</p>
      ...
      <div className="p-5 flex flex-col gap-3">
        <h3 className="text-[10px] font-bold text-[#3D4F6B] uppercase tracking-widest">Sources</h3>
      ...
      <div className="p-5 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <h3 className="text-[10px] font-bold text-[#3D4F6B] uppercase tracking-widest">Leads liés</h3>
          <button className="text-[10px] text-[#3462EE] hover:underline">Ajouter</button>
        </div>
        <div className="flex flex-col gap-2">
          {MOCK_LEADS.map(lead => (
            <div key={lead.id}
              className="flex items-center justify-between bg-[#121721] rounded-xl px-3 py-2.5 border border-[#232D3F] hover:border-[#3D4F6B] transition-colors cursor-pointer">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[10px] text-[#8896AB]">{lead.status} · {lead.date}</span>
                </div>
              </div>
      ...
      <div className="px-5 pb-5">
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-[#121721] border border-[#232D3F] rounded-xl p-3 text-center">
            <p className="text-lg font-bold text-white">{MOCK_LEADS.length}</p>
            <p className="text-[10px] text-[#8896AB]">Deals actifs</p>
          </div>
          <div className="bg-[#121721] border border-[#232D3F] rounded-xl p-3 text-center">
            <p className="text-sm font-bold" style={{ color: '#C8F135' }}>
