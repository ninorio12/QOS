  ...
  return (
    <div className="flex flex-col h-[calc(100vh-56px)] bg-[#070B12] overflow-hidden select-none">
      ...
      <div className="flex-shrink-0 flex items-center gap-1 px-4 py-2 border-b border-white/5">
        <div className="flex items-center gap-1 bg-soren-card/5 rounded-xl p-1">
          ...
          <Link href="/architecture" className="px-3 py-1.5 rounded-lg text-[12px] font-semibold bg-soren-card/10 text-white transition-all">
            Architecture
          </Link>
        </div>
      </div>
