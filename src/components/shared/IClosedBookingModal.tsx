...
export function IClosedBookingModal({ fullName, email, label, bookingUrl, onConfirm, onCancel }: {
    ...
    <Modal onClose={onCancel}>
      <div className="relative w-full max-w-sm bg-soren-card rounded-2xl shadow-2xl p-6 flex flex-col items-center gap-4 text-center">
        ...
        <div>
          ...
          {email && <p className="text-[11px] text-soren-subtle mt-1.5">Email pré-rempli : {email}</p>}
        </div>
