...
import { Search, Plus, X, Phone, Mail, Building2, ExternalLink, CalendarCheck, UserMinus, ChevronLeft, ChevronRight, Tag, Bookmark } from 'lucide-react'
...
type ProspRecord = { id: string; contactId: string; column: string; shortNote?: string; status: string; updatedAt: string; lostReason?: string; followUpReason?: string; followUpAt?: string; internalLead?: boolean; contact: Contact }
