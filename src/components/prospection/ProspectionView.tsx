...
/** Canal d'arrivée affiché : l'origine écrite prime, sinon la source du contact. */
const originOf = (r: ProspRecord): string | undefined =>
  r.origin ?? (r.contact.source === 'outbound' ? 'emailing' : undefined)
    ...
    <div className={`border rounded-lg px-2.5 py-1.5 flex flex-col justify-center gap-1 select-none transition-all min-h-[62px] ${
      ...
      {(r.cadrage || r.origin) && (
        <div className="flex flex-nowrap items-center gap-[3px] min-w-0">
          ...
          {originOf(r) === 'emailing' && (
            <span title="Lead issu de l'emailing sortant"
              className="flex-none inline-flex items-center gap-1 text-[9px] font-semibold px-[5px] py-[1px] rounded-full leading-tight whitespace-nowrap bg-[#FCE8E6] text-[#C5221F] dark:bg-red-500/15 dark:text-red-300">
              <svg width="9" height="9" viewBox="0 0 24 24" className="flex-shrink-0" aria-hidden="true">
                <path fill="currentColor" d="M1.636 5.455 12 13.09l10.364-7.636A1.64 1.64 0 0 0 20.727 4.5H3.273a1.64 1.64 0 0 0-1.637.955ZM1.5 6.3v11.564c0 .904.732 1.636 1.636 1.636h1.773V8.59L1.5 6.3Zm17.591 2.29v10.91h1.773c.904 0 1.636-.732 1.636-1.636V6.3l-3.409 2.29ZM4.909 19.5V8.59L12 13.91l7.091-5.32V19.5H4.909Z" />
              </svg>
              <span>Emailing</span>
            </span>
          )}
