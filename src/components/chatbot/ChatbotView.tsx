...
export default function ChatbotView({
  ...
  return (
    <div className="bg-soren-app min-h-screen p-6">
      {/* Header */}
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-soren-text text-xl font-bold">Configuration de Kai</h1>
        </div>
        <p className="text-soren-muted text-sm ml-11">
          Personnalisez le comportement et le prompt système de votre agent IA.
        </p>
      </div>

      {/* Section 1 — Prompt système */}
      <div className="bg-soren-card rounded-2xl p-6 shadow-sm mb-4">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-6 h-6 rounded-full bg-[#3462EE] flex items-center justify-center flex-shrink-0">
            <Bot size={12} className="text-white" />
          </div>
          <h2 className="text-soren-text font-semibold text-sm">Prompt de Kai</h2>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 mt-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-soren-sidebar text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-[#333333] disabled:opacity-50 transition-colors"
          >
            <Save size={13} />
      ...
      {/* Section 2 — Comportement */}
      <div className="bg-soren-card rounded-2xl p-6 shadow-sm mb-4">
        <h2 className="text-soren-text font-semibold text-sm mb-5">Comportement</h2>

        <div className="space-y-5">
          {/* Toggle auto-response */}
          <div className="flex items-center justify-between">
            <div>
              <p className="text-soren-text text-sm font-medium">Réponse automatique activée</p>
            ...
            >
              <span
                className={`absolute top-0.5 left-0.5 w-5 h-5 bg-soren-card rounded-full shadow transition-transform duration-200 ${
          ...
          {/* Budget minimum */}
          <div>
            <label className="block text-soren-text text-sm font-medium mb-1.5">
              Budget minimum (€)
            </label>
            <input
              type="number"
              ...
              min={0}
              step={500}
              className="w-48 text-sm text-soren-text bg-[#F9FAFB] border border-soren-border rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3462EE]/30 focus:border-[#3462EE] transition-colors"
            />
            <p className="text-soren-muted text-xs mt-1">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="text-sm text-soren-text bg-[#F9FAFB] border border-soren-border rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3462EE]/30 focus:border-[#3462EE] transition-colors"
                />
              </div>
              <div className="flex items-center gap-2">
      ...
      <div className="bg-[#F3F4F6] rounded-2xl p-6 shadow-sm">
        <p className="text-soren-muted text-sm leading-relaxed">
